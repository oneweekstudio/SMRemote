...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationFacebook/FacebookAdapter-6.3.1.0/FacebookAdapter.xcframework" "FacebookAdapter" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
